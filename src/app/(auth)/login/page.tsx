      ...
      <Card className="w-full max-w-md border-0 shadow-2xl bg-white/80 backdrop-blur-sm overflow-hidden relative z-10">
        ...
        <CardContent className="p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 mt-1">התחבר לחשבון שלך כדי להמשיך</p>
          </div>

          {/* Google Sign In */}
          <Button
            className="w-full h-12 rounded-xl bg-white border-2 border-gray-200 hover:border-gray-300 hover:bg-gray-50 text-gray-700 shadow-sm"
            variant="outline"
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-white px-3 text-gray-400">או</span>
            </div>
          </div>
          ...
          <form onSubmit={handleCredentialsSignIn} className="space-y-4">
            ...
            <Button
              type="submit"
              className="w-full h-12 rounded-xl bg-gradient-to-l from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white shadow-lg shadow-blue-500/30"
